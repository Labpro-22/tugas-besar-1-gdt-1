...
// RailroadTile::RailroadTile(int index, const std::string &code, const std::string &name, Railroad *railroad)
//     : PropertyTile(index, code, name, TileColor::DEFAULT, railroad) {}

// void RailroadTile::onLanded(Player &player, Game &game)
// {
//     Railroad *railroad = static_cast<Railroad *>(property);

//     if (railroad->getStatus() == PropertyStatus::BANK)
//     {
//         railroad->transferTo(player);
