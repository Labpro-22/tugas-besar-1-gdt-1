...
// StreetTile::StreetTile(int index, const std::string &code, const std::string &name, TileColor color, Street *street)
...
//             try
//             {
//                 player.getWallet().deduct(street->getPrice());
//                 street->transferTo(player);
