    ...
    for (Tile* tile : board.getAllTiles()) {
        ...
        if (tile->getCategory() == TileCategory::PROPERTY) {
            ...
            if(tile->getCode() == "PPH") {
                ...
                tileView = new TileView(*tile, "FREE", "PARKING", isCorner, "data/GUIAssets/freeparking_icon");
            } else if (tile->getCode() == "PPJ") {
                tileView = new TileView(*tile, "GO TO", "JAIL", isCorner, "data/GUIAssets/gotojail_icon");
            } else if (tile->getCode() == "KSP") {
                tileView = new TileView(*tile, "CHANCE", "", isCorner, "data/GUIAssets/chancetile_icon");
            } else if (tile->getCode() == "DNU") {
                tileView = new TileView(*tile, "COMMUNITY CHEST", "", isCorner, "data/GUIAssets/comchesttile_icon");
            } else if (tile->getCode() == "FES") {
                tileView = new TileView(*tile, "FESTIVAL", "", isCorner, "data/GUIAssets/festival_icon");
            }
        }
